...
// //async keyword allows us to write really asynchronous code or the syntax makeup for promises
...
//   if (password === "heyyouarecute")
//     return "yayyy!!!!";
//   throw "Invalid";
// };

// login("coolnicepeople", "heyyouarecute")
//   .then((msg) => {
...
// await pauses the execution of the function, until promise resolves
